...
public class UserServiceImpl extends ServiceImpl<UserMapper, User> implements UserService {
    ...
    public ResponseResult addUser(User user) {
        ...
        UserRole userRole = new UserRole(user1.getId(), roleIds.get(0));
    ...
    public ResponseResult getUser(Long id) {
        ...
        //根据id获取role
        UserRole userRole = userRoleService.getBaseMapper().selectById(id);
        Long roleId = userRole.getRoleId();
        //获取所有角色
        List<Role> roleList = roleService.list();
        UserDto userDto = new UserDto(roleId, roleList, userInfoVo);
